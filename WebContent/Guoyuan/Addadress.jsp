...
<div id="tbh5v0">
  <div class="login">      
    ...
    <section class="wrap">
      ...
      <form action="Addadressed.jsp" method="post" name="theForm" onsubmit="return checkConsignee(this)">
        <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
          <tr>
          	<td width="70">收货人</td>
            <td align="left" ><input id="name" name="name" placeholder="收货人姓名(必填)" type="text" class="inputBg_touch" value="" /> </td>
          </tr>
          <tr>
          	<td>联系电话</td>
            <td align="left" ><input placeholder="电话(必填)" name="mobile" id="mobile" type="text" class="inputBg_touch" value="" /></td>
          </tr>
          <tr>
          	<td>电子邮箱</td>
            <td align="left" ><input id="email" name="email" placeholder="电子邮件地址(必填)" type="text" class="inputBg_touch" value="" /></td>
          </tr>
          <tr>
          	<td>配送区域</td>
            <td align="left" >
          ...
          <tr>
          	<td>详细地址</td>
            <td align="left" ><input id="address" name="address" placeholder="详细地址(必填)" type="text" class="inputBg_touch" value="" /></td>
          </tr>
          <tr>
          	<td>邮政编码</td>
            <td align="left" ><input placeholder="邮政编码" id="zipcode" name="zipcode" type="text" class="inputBg_touch" value="" /></td>
          </tr>
          <tr>
            <td align="center" colspan="2">              <input type="submit" name="submit"  class="c-btn3"  value="新增收货地址"/>
