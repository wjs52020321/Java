...
<%@ page import="com.alibaba.tools.HtmlPagingHelper"%>
...
<table class="table table-hover" style="margin-top: 60px">
	...
	int totalCount=bll.GetAllCount();
			...
			for(News n : listData )
			{
	            ...
	            out.print("<a href='News/newsAdd.jsp'>新增</a>&nbsp");
	            out.print("<a href='News/newsEdit.jsp?Id="+ n.getId() +"'>编辑</a>&nbsp");
	            out.print("<a href='News/newsDelete.jsp?Id="+ n.getId() +"'>删除</a>");
	            }
	            out.print("</td>");     
	            out.println("</tr>");	
			} 
...
String pagingHtml=HtmlPagingHelper.CreatePagingHtml(pageIndex, pageCount);
//输出分页HTML代码
out.println(pagingHtml);
%>
